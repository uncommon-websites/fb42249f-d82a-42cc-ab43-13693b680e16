...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		...
		role: "Founder & CEO",
		image: "/generated/image-professional-entrepreneur-founder-headsh.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"Our league almost fell apart because tracking stats was a nightmare. I built this platform so no commissioner ever has to deal with that again."`}
			/>
